...
export default function TenantCreateArticle() {
  ...
  return (
    <TenantLayout pageTitle="Create Article" pageSubtitle="Write or generate a new article" section="Content"
      ...
      {/* AI Generator link */}
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 14px", background: "#f0fdfa", border: "1px solid #99f6e4", borderRadius: 8, marginBottom: 16 }}>
        <span style={{ fontSize: 12, color: "#374151" }}>Want AI to write this article?</span>
        <a href="/admin/generator" style={{ display: "inline-flex", alignItems: "center", gap: 4, padding: "5px 12px", borderRadius: 6, border: "1px solid #2dd4bf", background: "#fff", fontSize: 12, fontWeight: 600, color: "#0f766e", textDecoration: "none" }}>
          AI Generator &rarr;
        </a>
      </div>
