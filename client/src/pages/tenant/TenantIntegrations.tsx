...
const GROUPS: Array<{ title: string; desc: string; fields: KeyField[] }> = [
  ...
  { title: "Distribution & Communications", desc: "Social media and email services.", fields: [
    ...
    { key: "resend_segment_id", label: "Resend Segment ID", tooltip: "Newsletter sends target this segment. Found in Resend → Audiences → Segments.", placeholder: "d0b4c034-15fc-4afe-..." },
  ]},
