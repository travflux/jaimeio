...
export const categoryAdMap: Record<string, AdMessage> = {
  foreclosures: {
    ...
    ctaUrl: "https://getjaime.io/?utm_source=news&utm_medium=sidebar&utm_campaign=foreclosures",
    emailHeadline: "Foreclosure Opportunities in Your Inbox",
    emailDescription: "Get daily foreclosure insights + exclusive access to the JAIME.IO platform.",
  },
  flipping: {
    ...
    cta: "Get the Blueprint",
    ctaUrl: "https://getjaime.io/?utm_source=news&utm_medium=sidebar&utm_campaign=flipping",
  ...
  investing: {
    ...
    cta: "Get the Blueprint",
    ctaUrl: "https://getjaime.io/?utm_source=news&utm_medium=sidebar&utm_campaign=investing",
  ...
  roi: {
    ...
    cta: "Get the Blueprint",
    ctaUrl: "https://getjaime.io/?utm_source=news&utm_medium=sidebar&utm_campaign=roi",
  ...
  agents: {
    ...
    cta: "Get the Blueprint",
    ctaUrl: "https://getjaime.io/?utm_source=news&utm_medium=sidebar&utm_campaign=agents",
    emailHeadline: "Agent Strategies & Market Updates",
    emailDescription: "Daily market insights + exclusive agent resources from JAIME.IO.",
  },
  "short-sales": {
    ...
    cta: "Get the Blueprint",
    ctaUrl: "https://getjaime.io/?utm_source=news&utm_medium=sidebar&utm_campaign=short-sales",
  ...
  "side-hustle": {
    ...
    cta: "Get the Blueprint",
    ctaUrl: "https://getjaime.io/?utm_source=news&utm_medium=sidebar&utm_campaign=side-hustle",
    emailHeadline: "Passive Income Opportunities",
    emailDescription: "Weekly income strategies + access to the JAIME.IO platform.",
  },
  "recession-proof": {
    ...
    cta: "Get the Blueprint",
    ctaUrl: "https://getjaime.io/?utm_source=news&utm_medium=sidebar&utm_campaign=recession-proof",
  ...
  "9-5": {
    ...
    cta: "Get the Blueprint",
    ctaUrl: "https://getjaime.io/?utm_source=news&utm_medium=sidebar&utm_campaign=9-5",
  ...
  "job-seekers": {
    ...
    cta: "Get the Blueprint",
    ctaUrl: "https://getjaime.io/?utm_source=news&utm_medium=sidebar&utm_campaign=job-seekers",
...
export const genericBlueprintCTA: AdMessage = {
  ...
  cta: "Get the Blueprint",
  ctaUrl: "https://getjaime.io/?utm_source=news&utm_medium=generic&utm_campaign=homepage",
  emailHeadline: "Real Estate Investing Insights",
  emailDescription: "Daily market insights + exclusive access to the JAIME.IO platform.",
};
